#!/bin/bash
# ListingSpark AI - Million Dollar Video Generator V2
# Complete installation script - just copy and paste!

echo "🚀 Installing Million Dollar Video Generator V2..."
echo "=================================================="

# Create the enhanced video generator
cat > ~/projects/The360emerge/backend/video_tour_generator_pro_v2.py << 'ENDOFFILE'
"""
...
echo "✅ Video Generator V2 installed!"
echo ""
echo "📁 File location: ~/projects/The360emerge/backend/video_tour_generator_pro_v2.py"
echo ""
echo "🚀 Next steps:"
echo "1. Test with: python video_tour_generator_pro_v2.py"
echo "2. Replace old file: mv video_tour_generator_pro_v2.py video_tour_generator_pro.py"
echo "3. Update requirements if needed"
echo ""
echo "💡 Features included:"
echo "   ✅ Multi-provider voice engine (ElevenLabs → OpenAI → Edge)"
echo "   ✅ AI-powered script generation"
echo "   ✅ Professional title/contact cards"
echo "   ✅ Complete video compilation"
echo "   ✅ Branding and watermarks"
echo "   ✅ Social media format support"
echo "   ✅ Analytics and tracking"
echo "   ✅ Credit system ready"
echo ""
echo "🎉 You're ready to build million-dollar software!"
