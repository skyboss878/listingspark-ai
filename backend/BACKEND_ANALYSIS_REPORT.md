...
### Files Found:
### Core Files:
- **ai_director.py** (352 lines, 16K)
- **ai_director_old.py** (352 lines, 16K)
- **ai_image_enhancer.py** (85 lines, 4.0K)
- **ai_image_enhancer_old.py** (85 lines, 4.0K)
- **client_management.py** (641 lines, 24K)
- **db_adapter.py** (59 lines, 4.0K)
- **elevenlabs_voice.py** (109 lines, 4.0K)
- **elevenlabs_voice_old.py** (109 lines, 4.0K)
- **mls_integration.py** (288 lines, 12K)
- **payment.py** (137 lines, 8.0K)
- **platform_integrations.py** (706 lines, 28K)
- **platform_integrations_v2.py** (667 lines, 28K)
- **server.py** (2738 lines, 100K)
- **server_full.py** (2019 lines, 76K)
- **sqlite_auth.py** (177 lines, 8.0K)
- **trial_system.py** (232 lines, 8.0K)
- **video_tour_generator.py** (236 lines, 12K)
- **video_tour_generator_pro.py** (485 lines, 20K)
- **video_tour_generator_pro_v2.py** (887 lines, 36K)
- **viral_content_engine.py** (330 lines, 16K)
